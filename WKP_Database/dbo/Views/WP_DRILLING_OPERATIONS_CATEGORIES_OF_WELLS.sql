...
AS
SELECT     TOP (100) PERCENT SUM(CAST(CAST(Actual_No_Drilled_in_Current_Year AS decimal) AS int)) AS Actual_No_Drilled_in_Current_Year,
SUM(CAST(CAST(Proposed_No_Drilled AS decimal) AS int)) 
