...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_CHAIRPERSON_new");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_COMPANY_INFORMATION_");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_COMPANY_INFORMATION_AUDIT_");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_COMPANY_INFORMATION");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_SCRIBE_new");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_TYPE_OF_TEST");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ADMIN_Year");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_application_desk_history_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Concession_Situation");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Drilling_Operations_");
        ...
        modelBuilder.Entity<FIELD_DEVELOPMENT_PLAN_EXCESSIVE_RESERf>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("FIELD_DEVELOPMENT_PLAN_EXCESSIVE_RESERVES");
        ...
        {
            entity.HasKey(e => e.Geophysical_Activities_ProcessingId).HasName("PK_Geophysical_Activities_Processing");
        ...
        modelBuilder.Entity<HSE_CLIMATE_CHANGE_AND_AIR_QUALITY>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_CLIMATE_CHANGE_AND_AIR_QUALITY");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_COMMUNITY_DISTURBANCES_AND_OIL_SPILL_COST_NEW");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ENVIRONMENTAL_COMPLIANCE_MONITORING_NEW");
        ...
        modelBuilder.Entity<HSE_ENVIRONMENTAL_MANAGEMENT_SYSTEM>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_ENVIRONMENTAL_MANAGEMENT_SYSTEM");
        ...
        modelBuilder.Entity<HSE_OCCUPATIONAL_HEALTH_MANAGEMENT>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_OCCUPATIONAL_HEALTH_MANAGEMENT");
        ...
        modelBuilder.Entity<HSE_SAFETY_CULTURE_TRAINING>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_SAFETY_CULTURE_TRAINING");
        ...
        modelBuilder.Entity<HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU");
        ...
        modelBuilder.Entity<HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_SCHOLASHIP_SCHEME>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_SCHOLASHIP_SCHEME");
        ...
        modelBuilder.Entity<HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_TRAINING_SCHEME>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_TRAINING_SCHEME");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_WASTE_MANAGEMENT_NEW");
        ...
        modelBuilder.Entity<HSE_WASTE_MANAGEMENT_SYSTEM>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("HSE_WASTE_MANAGEMENT_SYSTEM");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Presentation_Upload");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_permit_id");
        ...
        modelBuilder.Entity<RESERVES_UPDATES_DEPLETION_RATE>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("RESERVES_UPDATES_DEPLETION_RATE");
        ...
        modelBuilder.Entity<RESERVES_UPDATES_LIFE_INDEX>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("RESERVES_UPDATES_LIFE_INDEX");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_StrategicBusinessUnit");
        ...
        {
            entity.HasKey(e => e.StaffID).HasName("PK_Staff_UT");
