...
public partial class WP_OIL_CONDENSATE_PRODUCTION_ACTIVITIES_monthly_Activities_Five_Year_Trend_for_Companies_Reserve_Replacement_Ratio
{
    ...
    public int? _2025 { get; set; }

    public int? _2026 { get; set; }

    public int? _2027 { get; set; }

    public int? _2028 { get; set; }

    public int? _2029 { get; set; }
