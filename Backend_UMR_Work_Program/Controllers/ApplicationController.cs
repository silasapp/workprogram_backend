                ...
                if (application != null)
                {
                    ...
                    switch (getStaffSBU.SBU_Code)
                    {
                        ...
                        case "PLN":
                                ...
                                var BudgetCapexOpex = await (from c in _context.BUDGET_CAPEX_OPEXes where c.CompanyNumber == application.CompanyID && c.Year_of_WP == year select c).FirstOrDefaultAsync();
